...
Please read these terms and conditions carefully before using imamBot.
...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to imamBot.
...
- __Terms and Conditions__ (also referred as "Terms") mean these Terms and Conditions that form the entire agreement
  ...
  with the help of the [Terms and Conditions Generator](https://www.termsfeed.com/terms-conditions-generator/).
...
- __Website__ refers to imamBot, accessible
  from [https://github.com/ahmetmutlugun/imam](https://github.com/ahmetmutlugun/imam)
