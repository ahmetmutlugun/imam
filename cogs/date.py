...
from prayer import get_local_time_offset
...
class Date(commands.Cog):
    ...
    @slash_command(name='hijri', description="Gives the Hijri date for the current date and any holidays that are currently taking place")
